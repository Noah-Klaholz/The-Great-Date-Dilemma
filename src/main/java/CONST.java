public class CONST {
    public static String exit_Button_path = "src/main/resources/exitButton.png";
    public static String save_Button_path = "src/main/resources/saveButton.png";
    public static String start_Button_path = "src/main/resources/startButton.png";
    public static String achievement_Button_path = "src/main/resources/achievementButton.png";
    public static String menu_Button_path = "src/main/resources/mainMenuButton.png";
